...
import TabbarView from "@/learn/vue/page/phone/tabbar/TabbarView.vue";
import {ref} from "vue";
...
const callAndroidProtocol = () => {
  // 约定的url协议为：util://webview?arg1=111&arg2=222
  document.location = "util://webview?arg1=111&arg2=222";
}
...
function clickPrompt(){
  // 调用prompt（）
  const result = prompt("util://webview?arg1=111&arg2=222");
  // 展示android回传的值
  confirm("util prompt receive: " + result);
}
